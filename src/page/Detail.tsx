...
const Detail = () => {
  ...
  const { bilingual, flavorText, language } = useLanguage(
          ...
          {isLoading ? (
            ...
            <>
              <S.HeadBox>
                ...
                <p># {pokemonInfo?.id}</p>
                <p>
                  {pokemonSpeciesInfo?.names === undefined
                    ? '이름 정보를 불러올수 없습니다'
                    : bilingual && bilingual[0]?.name}
                </p>
              </S.HeadBox>
              <S.BodyBox>
                <div>
                ...
                <div>
                  <h3>
                    {language === 'ko' ? pokemonSpeciesInfo?.genera[1]?.genus : pokemonSpeciesInfo?.genera[7]?.genus}
                  </h3>
                </div>
